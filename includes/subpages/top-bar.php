<div class="header navbar navbar-inverse navbar-fixed-top">
		...
		<div class="header-inner">
			<!-- BEGIN LOGO -->  
			<a class="navbar-brand" href="#"><span style="font-size: 22px;
color: #fff;">Amazone <span style="font-size: 22px;
color: #F00;">Seller</span></span></a>
			<!-- END LOGO -->
			<!-- BEGIN RESPONSIVE MENU TOGGLER --> 
			<a href="javascript:;" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
			<img src="<?php echo THEME_BASE; ?>metronic/img/menu-toggler.png" alt="">
			</a> 
			...
			<ul class="nav navbar-nav pull-right">
						...
						<li>
							<div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 250px;"><ul class="dropdown-menu-list scroller" style="height: 250px; overflow: hidden; width: auto;">
								<li>  
									...
									<span class="photo"><img src="./<?php echo THEME_BASE; ?>metronic/img/avatar2.jpg" alt=""></span>
									<span class="subject">
								...
								<li>  
									<a href="inbox.html?a=view">
									<span class="photo"><img src="./<?php echo THEME_BASE; ?>metronic/img/avatar3.jpg" alt=""></span>
									<span class="subject">
								...
								<li>  
									<a href="inbox.html?a=view">
									<span class="photo"><img src="./<?php echo THEME_BASE; ?>metronic/img/avatar1.jpg" alt=""></span>
									<span class="subject">
				...
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                <?php  $u = getUser($_SESSION['user_id']);
				
					if($u['login_type'] == '0'){
				   ?>
					<img alt="" width="29px" height="29px" src="<?php echo SITE_URL; ?>user-images/thumb_<?php echo $u['image']; ?>">
                    <?php }else { ?>
                    <img alt="" width="29px" height="29px" src="http://graph.facebook.com/<?php echo $u['fb_id']; ?>/picture">
                    <?php } ?> 
					...
					<ul class="dropdown-menu">
						...
						<li><a href="?cmd=logout"><i class="fa fa-key"></i> Log Out</a></li>
					</ul>
				</li>
