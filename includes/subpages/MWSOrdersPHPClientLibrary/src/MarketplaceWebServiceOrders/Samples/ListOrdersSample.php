 ...
 ***********************************************************************/
 ...
 $request->setMarketplaceId(array('ATVPDKIKX0DER'));
 $tmp		=		gmdate('Y-m-d\TH:i:s\Z', time()-24*60*60);
 $request->setCreatedAfter($tmp);
/* $tmp		=		new DateTime("2014-12-14 00:00:00");
 $request->setCreatedBefore($tmp);*/
