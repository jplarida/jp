...
$config = array (
 ...
 $report_type_array->setType('_GET_FLAT_FILE_PAYMENT_SETTLEMENT_DATA_');
              ...
              $response = $service->getReportList($request);
                ...
                if ($response->isSetGetReportListResult()) { 
                    ...
                    foreach ($reportInfoList as $reportInfo) {
					   ...
					   echo $reportInfo->getReportType()."----".$report_id."<br/>";
					//echo $report_id."<br />";
					  
                   //mysql_query("INSERT INTO `fulfillments` ( `report_type`, `report_date`, `report_id`, `date_time`) VALUES ( ' " . $reportInfo->getReportType() . "', '" . $reportInfo->getAvailableDate()->format(DATE_FORMAT) . "', '$report_id', CURRENT_TIMESTAMP)");					   
