...
$report_row		=	$sql_obj->QFetchArray("SELECT * FROM reports WHERE report_type = '_GET_MERCHANT_LISTINGS_DATA_' ORDER BY date_time DESC LIMIT 1");



$report_obj		=		new Reporting($amazone_array);
$report_obj->UpdateInventory($report_row['report_id'],$report_row['user_id']); 
