...
$config = array (
 ...
 $report_type_array->setType('_GET_FBA_FULFILLMENT_INVENTORY_HEALTH_DATA_');
      ...
      try {
              $response = $service->getReportList($request);
                ...
                if ($response->isSetGetReportListResult()) { 
                   ...
                   mysql_query("INSERT INTO `reports` ( `report_type`, `report_date`, `report_id`, `date_time`) VALUES ( ' " . $reportInfo->getReportType() . "', '" . $reportInfo->getAvailableDate()->format(DATE_FORMAT) . "', '$report_id', CURRENT_TIMESTAMP)");					   
