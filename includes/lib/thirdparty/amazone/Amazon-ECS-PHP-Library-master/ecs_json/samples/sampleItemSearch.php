...
defined('AWS_API_KEY') or define('AWS_API_KEY', 'AKIAIPT2XQP445WUV3YA');
defined('AWS_API_SECRET_KEY') or define('AWS_API_SECRET_KEY', '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');
...
try
{
   ...
   $response = $amazonEcs->country('de')->category('All')->responseGroup('Small')->search('The Beatles');
   //var_dump($response);
