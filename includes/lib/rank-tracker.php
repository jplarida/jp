...
<div class="page-container"> 
  ...
  <div class="page-content"> 
    ...
    <!-- BEGIN PAGE CONTENT-->
    <div class="row">
      <div class="col-md-12"> <a style="margin-bottom:10px;"  class="btn green" href="#form_modala01" data-toggle="modal"> <i class="fa fa-plus"></i> Add Rank Tracker </a>
        ...
        <div class="tabbable tabbable-custom boxless">
		 ...
		 $rank_row 		=	$sql_obj->QFetchRowArray("SELECT rt.* FROM rank_tracker rt
          WHERE rt.user_id = '".$_SESSION['user_id']."' ");		
	  ...
	  ?>
                      ...
                      <td><a onClick="showRankDetails('ra_<?php echo $row['id'] ?>');" href="javascript:void(0)"><strong>> <?php echo getProductName($row['product_id']);  ?></strong></a></td>
                       ...
                       <td>
                        ...
                        <a onClick="deleteRecord('s<?php echo $row['id']; ?>','<?php echo $row['id']; ?>','rank_tracker','<td colspan=4>Rank Tracker is deleted sucessfully</td>');" href="javascript:void(0);" ><span class="label label-sm label-info">Delete</span></a>
