    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="tabbable tabbable-custom boxless">
              ...
              <div class="tab-pane active" id="tab_1">
                <div class="portlet box blue">
                  <div class="portlet-title">
                    <div class="caption"><i class="fa fa-list-ul"></i>Inventory Listing</div>
		 ...
		 $query 		=	mysql_query("SELECT * from user_inventory where user_id = '".$_SESSION['user_id']."'");		
  ...
  while($row		=	mysql_fetch_array($query))	{
	  ...
	  ?>
                        <tr class="odd" id="s<?php echo $row['id']; ?>">
                         <td><?php echo $i++; ?></td>
                          <td><?php $arr	=	 explode("-",$row['item_name']);echo $arr[0]; ?></td>
                          <td><?php echo $row['asin1']; ?></td>
