<ul class="page-sidebar-menu">
  ...
  <li> 
    ...
    <li class="active "> <a href="users.php"> <i class="fa fa-group"></i> <span class="title">Site Users</span> </a></li>
     <li > <a href="api-call.php"> <i class="fa fa-group"></i> <span class="title">Amazone API Call</span> </a></li>
    
    <li> <a href="setting.php"> <i class="fa fa-gear"></i> <span class="title">Site Setting</span> </a></li>
