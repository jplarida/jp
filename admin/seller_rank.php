...
<div class="page-container"> 
    ...
    <div class="row">
      <div class="col-md-12"> 
        ...
        <div class="tabbable tabbable-custom boxless">
		 ...
		 $query 		=	mysql_query("SELECT sr.*,p.asin ,p.name as pname FROM seller_rank sr, products p WHERE sr.user_id = $user_id AND sr.product_id = p.id ");		
  ...
  while($row		=	mysql_fetch_array($query))	{
	  ...
	  ?>
                      ...
                      <?php include('includes/subpages/plugins/seller-rank-chart.php'); ?>
